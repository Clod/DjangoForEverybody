...
class Ad(models.Model) :
    ...
    # An Ad can have several comments from the same User 
    # A User can make several comments about different ads 
    # So, we need a ManyToManyField and the link is the Comments table
